...
from utils.frozen_ego_minimum.utils import read_json, write_json
...
class ConfigParser:
    def __init__(self, args, options='', timestamp=True, test=False, eval_mode=None):
        ...
        if args.resume is None:
            ...
            if eval_mode == "ego4d-nlq-v":
                resume_cfg_fname = Path('./configs/ego4d-nlq-v.json')
            elif eval_mode == "ego4d-nlq-l":
                resume_cfg_fname = Path('./configs/ego4d-nlq-l.json')

            elif eval_mode == "ego4d-mq-v":
                resume_cfg_fname = Path('./configs/ego4d-mq-v.json')
            elif eval_mode == "ego4d-mq-l":
                resume_cfg_fname = Path('./configs/ego4d-mq-l.json')
