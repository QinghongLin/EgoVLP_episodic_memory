...
class Ego4d_NLQ_L(TextVideoDataset):
    """
    WebVid Dataset.
    ...
    def _load_metadata(self):
        metadata_dir = '/apdcephfs/private_qinghonglin/video_dataset/ego4d/benchmark_splits/nlq/'
        ...
        self.metadata = pd.DataFrame(columns=['video_uid', 'query', 'clip_uid',
                                              'video_start_sec', 'video_end_sec', 'video_start_frame', 'video_end_frame'])
